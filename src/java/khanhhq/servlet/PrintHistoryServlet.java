...
public class PrintHistoryServlet extends HttpServlet {
    ...
    private final String DISPLAYHISTORY = "displayHistory.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = DISPLAYHISTORY;
        try {
            HttpSession session = request.getSession();
            String userID = (String) session.getAttribute("USERID");
            /* TODO output your page here. You may use following sample code. */
            TblHistoryDAO dao = new TblHistoryDAO();
            dao.printHistory(userID);
            List<TblHistoryDTO> result = dao.getlistHistory();
            if (result != null) {
